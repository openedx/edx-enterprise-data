...
def request_user_has_implicit_access(*args, **kwargs):
    ...
    return request_user_has_implicit_access_via_jwt(decoded_jwt, ENTERPRISE_DATA_ADMIN_ROLE, enterprise_id_in_request)
...
def request_user_has_explicit_access(*args, **kwargs):
    ...
    return user_has_access_via_database(
        request.user, ENTERPRISE_DATA_ADMIN_ROLE, EnterpriseDataRoleAssignment, enterprise_id_in_request
    )
