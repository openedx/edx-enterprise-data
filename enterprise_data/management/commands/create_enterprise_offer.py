...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            info = f"Created EnterpriseOffer for enterprise {enterprise_customer_uuid}\n"
            sys.stdout.write(info)
        except Exception as exc:
            info = f"Error trying to create EnterpriseOffer for enterprise {enterprise_customer_uuid}\n"
