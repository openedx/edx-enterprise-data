...
class TestEnterpriseEnrollment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.enrollment = EnterpriseEnrollmentFactory(enterprise_user=enterprise_user, course_id=course_id)
        super().setUp()
...
class TestEnterpriseOffer(unittest.TestCase):
    ...
    def setUp(self):
        self.enterprise_offer = EnterpriseOfferFactory(
            enterprise_customer_uuid="ee5e6b3a-069a-4947-bb8d-d2dbc323396c", enterprise_name="test-enterprise"
        )
        super().setUp()
    ...
    def test_string_conversion(self, method):
        ...
        """
        expected_str = (
            f"<Enterprise Offer {self.enterprise_offer.offer_id} for {self.enterprise_offer.enterprise_name}>"
        )
...
class TestEnterpriseSubsidyBudget(unittest.TestCase):
    ...
    def setUp(self):
        self.enterprise_subsidy_budget = EnterpriseSubsidyBudgetFactory(
            enterprise_customer_uuid="ee5e6b3a-069a-4947-bb8d-d2dbc323396c", enterprise_customer_name="test-enterprise"
        )
        super().setUp()
    ...
    def test_string_conversion(self, method):
        ...
        """
        expected_str = (
            f"<Enterprise Budget {self.enterprise_subsidy_budget.subsidy_access_policy_uuid} "
...
class TestEnterpriseGroupMembership(unittest.TestCase):
    ...
    def test_string_conversion(self, method):
        ...
        """
        expected_str = (
            "<Enterprise Group Membership: Test Group "
