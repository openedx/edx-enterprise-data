# Generated by Django 3.2.20 on 2023-10-25 10:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Demo Enterprise Learner',
                'verbose_name_plural': 'Demo Enterprise Learner',
                'db_table': 'demo_enterprise_learner',
                'ordering': ['-user_email'],
            },
        ),
        migrations.CreateModel(
            name='DemoEnterpriseLearnerEnrollment',
            fields=[
                ...
                ('enterprise_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='enterprise_data.demoenterpriselearner')),
            ],
            options={
                'verbose_name': 'Demo Enterprise Learner Enrollment',
                'verbose_name_plural': 'Demo Enterprise Learner Enrollments',
