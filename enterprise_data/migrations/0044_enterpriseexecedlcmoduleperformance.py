...
class Migration(migrations.Migration):
    dependencies = [
        (
            "enterprise_data",
            "0040_auto_20240718_0536_squashed_0043_alter_enterpriselearnerenrollment_enterprise_enrollment_id",
        ),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "percentage_completed_graded_activities",
                    models.DecimalField(decimal_places=2, max_digits=38, null=True),
                ),
