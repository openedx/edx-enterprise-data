# Generated by Django 4.2.14 on 2024-08-08 06:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_mark', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ('assign_grade', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ...
                ('percentage_completed_activities', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ('extensions_requested', models.PositiveIntegerField(null=True)),
                ('module_grade', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ('log_viewed', models.PositiveIntegerField(null=True)),
                ('hours_online', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ...
                ('percentage_completed_graded_activities', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
                ...
                ('pass_grade', models.DecimalField(decimal_places=20, max_digits=38, null=True)),
            ],
            options={
