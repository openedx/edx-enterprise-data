...
class EnterpriseExecEdLCModulePerformance(models.Model):
    ...
    final_mark = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    assign_grade = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    ...
    percentage_completed_activities = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    extensions_requested = models.PositiveIntegerField(null=True)
    module_grade = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    log_viewed = models.PositiveIntegerField(null=True)
    hours_online = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    ...
    percentage_completed_graded_activities = models.DecimalField(max_digits=38, decimal_places=20, null=True)
    ...
    pass_grade = models.DecimalField(max_digits=38, decimal_places=20, null=True)
