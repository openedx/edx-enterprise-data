...
class EnterpriseExecEdLCModulePerformance(models.Model):
    ...
    final_mark = models.DecimalField(max_digits=38, decimal_places=20)
    assign_grade = models.DecimalField(max_digits=38, decimal_places=20)
    ...
    percentage_completed_activities = models.DecimalField(max_digits=38, decimal_places=20)
    extensions_requested = models.PositiveIntegerField()
    module_grade = models.DecimalField(max_digits=38, decimal_places=20)
    log_viewed = models.PositiveIntegerField()
    hours_online = models.DecimalField(max_digits=38, decimal_places=20)
    ...
    percentage_completed_graded_activities = models.DecimalField(max_digits=38, decimal_places=20)
    ...
    pass_grade = models.DecimalField(max_digits=38, decimal_places=20)
