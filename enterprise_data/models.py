...
class DemoEnterpriseLearner(models.Model):
    """
    Information related to Demo Enterprise Learner.
    """
    ...
    class Meta:
        app_label = 'enterprise_data'
        db_table = 'demo_enterprise_learner'
        verbose_name = _("Demo Enterprise Learner")
        verbose_name_plural = _("Demo Enterprise Learner")
        ordering = ['-user_email']
...
class DemoEnterpriseLearnerEnrollment(models.Model):
    """
    Information related to Demo Enterprise Learner Enrollments.
    """
    ...
    class Meta:
        app_label = 'enterprise_data'
        db_table = 'demo_enterprise_learner_enrollment'
        verbose_name = _("Demo Enterprise Learner Enrollment")
        verbose_name_plural = _("Demo Enterprise Learner Enrollments")
