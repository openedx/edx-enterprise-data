        ...
        for subject in subjects:
            try:
                if isinstance(subject, str):
                    ...
                    error_msg = f"Subject is not a string or a dictionary: {subject}"
...
class EnterpriseAPIClient(EdxOAuth2APIClient):
    ...
    def get_all_enterprise_reporting_configs(self, **kwargs):
        ...
        """
        return self._load_data(self.ENTERPRISE_REPORTING_ENDPOINT, should_traverse_pagination=True, **kwargs)
