...
class EnterpriseReportSender:
    ...
    VERTICA_QUERY = (
        "SELECT {fields} FROM business_intelligence.enterprise_enrollment"
    ...
    def data_report_file_name(self):
        ...
        return f"{self.FILE_WRITE_DIRECTORY}/{self.enterprise_customer_uuid}_{self.data_type}_{self.report_type}{date_str}.{self.report_type}"
    ...
    def send_enterprise_report(self):
        ...
        if files:
            ...
            LOGGER.warning(
                f"No {self.data_type} {self.report_type} reports were generated for {self.enterprise_customer_name}! Moving on..."
            )
    ...
    def _generate_enterprise_report(self):
        ...
        return getattr(self, f"_generate_enterprise_report_{self.data_type}_{self.report_type}")()
    ...
    def _generate_enterprise_report_progress_csv(self):
        ...
        with open(self.data_report_file_name, "w") as data_report_file:
            ...
            query = self.VERTICA_QUERY.format(
                fields=",".join(self.VERTICA_QUERY_FIELDS), enterprise_id=UUID(self.enterprise_customer_uuid).hex
            )
